...
const { CSVLoader } = require('../../app/loaders/csvloader')
...
describe('csvLoader tests', () => {
    ...
    uut
      ...
      .pipe(new PassThrough({
        ...
        transform (chunk, _, callback) {
          ...
          if (lineCount === testData.length - 1) { done() }
          lineCount += 1
          callback(null, chunk)
        }
      }))
  ...
  test('should count csv file lines', (done) => {
    const testData = [
      'column1, column2, column3\n',
      '1,2,3\n',
      '4,5,6\n'
  ...
  test('should remove non-printable characters from CSV data', (done) => {
    const testData = [
      'column1,column2,column3\n',
      '1,\x00\x1F2,3\n',
      '4,5,\x7F\x9F6\n'
  ...
  test('should load from a readable stream', (done) => {
    const testData = [
      'column1,column2,column3\n',
      '1,2,3\n',
      '4,5,6\n'
  ...
  test('should count lines from a readable stream', (done) => {
    const testData = [
      'column1,column2,column3\n',
      '1,2,3\n',
      '4,5,6\n'
  ...
  test('should remove non-printable characters from CSV data from a stream', (done) => {
    const testData = [
      'column1,column2,column3\n',
      '1,\x00\x1F2,3\n',
      '4,5,\x7F\x9F6\n'
  ...
  test('should start processing from the specified starting line', (done) => {
    const testData = [
      '2',
      'column1,column2,column3\n',
      '1,2,3\n',
  ...
  test('should handle relaxed quote parsing', (done) => {
    const testData = [
      'column1,column2,column3\n',
      '1,"2,3",4\n',
      '5,"6,7",8\n'
  ...
  test('should handle empty CSV', (done) => {
    const testData = ''
    const readableStream = new PassThrough()
    readableStream.end(testData)
  ...
  test('should handle CSV with only headers', (done) => {
