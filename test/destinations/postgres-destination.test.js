...
describe('postgresDestination tests', () => {
  ...
  test('should produce debug output', (done) => {
    const uut = new PostgresDestination(config)
    uut.setConnection(mockConnection)
    const testData = ['a', 'b', 'c']
    testData.errors = []
  ...
  test('should format a date as specified', (done) => {
  ...
  test('should write a sql statement', () => {
  ...
  test('should write a sql statement with schema if provided', () => {
    const mockTable = 'MockTable'
    const mockChunk = ['a', '19-06-2024 00:00', 'c']
  ...
  test('should write a sql statement with a date format', () => {
  ...
  test('should write a sql statement correctly if date but no value', () => {
    const newMapping = JSON.parse(JSON.stringify(config.mapping))
    newMapping[1].targetType = 'date'
    newMapping[1].format = 'DD-MM-YYYY HH24:MI:SS'
    const mockTable = 'MockTable'
  ...
  test('should write a sql statement when a target column is a keyword', () => {
    const newMapping = JSON.parse(JSON.stringify(config.mapping))
  ...
  test('should write a sql statement when a source column is a keyword and there is no target column', () => {
    const newMapping = JSON.parse(JSON.stringify(config.mapping))
  ...
  test('should write a sql statement when a target column type is a number', () => {
    const newMapping = JSON.parse(JSON.stringify(config.mapping))
  ...
  test('should write a sql statement when a target column type is a number but the value is NaN', () => {
    const newMapping = JSON.parse(JSON.stringify(config.mapping))
    newMapping[1].targetType = 'number'
    newMapping[1].format = 'DD-MM-YYYY HH24:MI:SS'
    const mockTable = 'MockTable'
  ...
  test('should write a sql statement when a target column has the returning flag set', () => {
    const newMapping = JSON.parse(JSON.stringify(config.mapping))
  ...
  test('should fire off any addtional tasks', (done) => {
    const mockTasks = [{
      write: jest.fn()
    }]
    const uut = new PostgresDestination(config)
  ...
  test('should get connection name', () => {
    const uut = new PostgresDestination(config)
    uut.setConnection(mockConnection)
  ...
  test('should return false if mapping does not contain one or more mappings that have the returning flag set', () => {
    const newConfig = JSON.parse(JSON.stringify(config))
    expect(hasReturningColumns(newConfig.mapping)).toEqual(false)
  })
  test('should return array of mappings that have the returning flag set', () => {
    const newConfig = JSON.parse(JSON.stringify(config))
    newConfig.mapping[0].returning = true
