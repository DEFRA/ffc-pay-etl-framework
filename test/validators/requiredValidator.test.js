...
const { RequiredValidator } = require('../../app/validators/requiredValidator')
const { Readable, PassThrough } = require('node:stream')

describe('requiredValidator tests', () => {
  test('should not add any errors if all required fields are present', (done) => {
  ...
  test('should add errors for all missing required fields', (done) => {
  ...
  test('should use custom error message', (done) => {
